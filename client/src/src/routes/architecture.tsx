      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <p className="mt-3 text-muted-foreground max-w-2xl">
            Click a ministry to see what data it brokers through NGDXH. Each line is an authorized,
            encrypted, audited API channel — not a copy of the data.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-6">
          ...
          <div className="glass rounded-xl p-4 relative overflow-hidden">
            ...
            <svg viewBox={`0 0 ${size} ${size}`} className="w-full relative">
              ...
              <text x={cx} y={cy + 14} textAnchor="middle" className="fill-gold" fontSize={10}>
                Secure Core
              </text>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div
                  className="w-12 h-12 rounded-md flex items-center justify-center font-mono text-sm font-bold"
                  style={{
                    background: ministry.color + "22",
