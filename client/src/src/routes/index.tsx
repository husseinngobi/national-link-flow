...
const QUICK_SERVICES = [
  {
    icon: FileCheck2,
    t: "Verify a document",
    d: "Check the authenticity of a permit, certificate or ID.",
    to: "/verify-status",
  },
  {
    icon: Clock,
    t: "Track an application",
    d: "See the real-time status of any government service request.",
    to: "/verify-status",
  },
  {
    icon: Bot,
    t: "Ask the AI Assistant",
    d: "Multilingual help for any government service — 24/7.",
    to: "/assistant",
  },
  {
    icon: Users,
    t: "Citizen portal",
    d: "Your personal inbox for every ministry interaction.",
    to: "/citizen",
  },
];
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="mb-8">
          ...
          <h2 className="text-2xl lg:text-3xl font-display font-bold">
            Common things citizens do here
          </h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {QUICK_SERVICES.map((s, i) => (
            ...
            >
              <Link
                to={s.to}
                className="block glass rounded-xl p-5 hover:border-primary/40 transition h-full group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {POPULAR.map((p) => (
              <div
                key={p.t}
                className="glass rounded-lg p-4 flex items-center gap-3 hover:border-gold/40 transition"
              >
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold leading-tight">
              Your data stays with your government —{" "}
              <span className="text-gold">protected by design.</span>
            </h2>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              NGDXH follows a zero-trust security model and separates citizen-facing services from
              protected government operations. Every exchange is encrypted, consent-based and fully
              audited under the Uganda Data Protection &amp; Privacy Act 2019.
            </p>
            <Link
              to="/security"
            ...
            {[
              {
                ...
                d: "Every request secured with mTLS &amp; AES-256.",
              },
              {
                icon: ShieldCheck,
                t: "Consent-based",
                d: "Your data is shared only when authorized.",
              },
              {
                icon: Languages,
                t: "Multilingual",
                d: "Services in English, Luganda, Runyankole, Acholi, Lusoga.",
              },
