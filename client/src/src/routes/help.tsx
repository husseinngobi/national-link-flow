  ...
  head: () => ({
    meta: [
      { title: "Help Center — NGDXH" },
      {
        name: "description",
        content:
          "Get help with government services. FAQs, contact information and support channels.",
      },
    ],
  }),
});
...
const FAQS = [
  {
    ...
    a: "Use the Verify Status page and enter your reference number. Results are returned in seconds.",
  },
  {
    q: "Is my data safe with NGDXH?",
    a: "Yes. NGDXH does not store your records — it brokers authorized exchanges between ministries. Every transaction is encrypted and audited.",
  },
  {
    q: "What languages does the AI Assistant speak?",
    a: "English, Luganda, Runyankole, Acholi and Lusoga.",
  },
  {
    q: "I lost my reference number — what now?",
    a: "Sign in to the Citizen Portal to see all your past applications, or contact the issuing ministry directly.",
  },
  {
    q: "How do I report fraud or misuse?",
    a: "Email gdr@ict.go.ug or call the toll-free line 0800 100 000. All reports are confidential.",
  },
  {
    q: "Why was a service request denied?",
    a: "Each ministry has its own rules. Open the request from your Citizen Portal to see the specific reason.",
  },
];
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-12">
          <div className="glass rounded-xl p-5">
            ...
            <a href="tel:0800100000" className="text-primary hover:underline text-sm">
              0800 100 000
            </a>
          ...
          <div className="glass rounded-xl p-5">
            ...
            <a href="mailto:support@ngdxh.go.ug" className="text-primary hover:underline text-sm">
              support@ngdxh.go.ug
            </a>
