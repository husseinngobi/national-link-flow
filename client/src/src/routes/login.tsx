      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
            Authorized government personnel only. Multi-factor authentication and full audit logging
            are enforced.
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      <div
                        className={`w-9 h-9 rounded-md flex items-center justify-center ${isAgency ? "bg-gold/20 text-gold" : "bg-accent"}`}
                      >
            ...
            <form onSubmit={submitPin} className="glass rounded-xl p-6">
              ...
              <div className="mt-5 flex gap-2">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="flex-1 px-4 py-2.5 rounded-md border border-border hover:bg-accent text-sm"
                >
                  Back
                </button>
                <button
                  type="submit"
                  className="flex-[2] inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-md bg-primary text-primary-foreground font-medium hover:bg-primary/90"
                >
          ...
          <div className="max-w-md mx-auto">
            <form onSubmit={submitOtp} className="glass rounded-xl p-6">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                A 6-digit code was sent to your registered government device. Enter it below to
                complete sign-in.
              </p>
              ...
              <button
                type="submit"
                className="mt-5 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-md bg-primary text-primary-foreground font-medium hover:bg-primary/90"
              >
                <Shield className="w-4 h-4" /> Enter Operations Center{" "}
                <ArrowRight className="w-4 h-4" />
              </button>
              <button
                type="button"
                onClick={() => setStep(2)}
                className="mt-2 w-full px-4 py-2 rounded-md border border-border text-xs text-muted-foreground hover:bg-accent"
              >
                Back
              </button>
            </form>
...
function CredentialSheet({
  ...
  return (
    <div className="glass rounded-xl p-6">
      ...
      <p className="text-xs text-muted-foreground mb-4">
        Showcase only — all officers share PIN{" "}
        <span className="font-mono text-foreground">{DEMO_PIN}</span>. MFA OTP is{" "}
