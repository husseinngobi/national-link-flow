      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        <div className="mb-8">
          ...
          <h1 className="text-3xl lg:text-4xl font-display font-bold">
            Track your government services
          </h1>
          <p className="mt-2 text-muted-foreground">
            One inbox for every ministry. Track applications, verifications and certificates from
            any connected MDA.
          </p>
        </div>
          ...
          <div className="glass rounded-xl p-5">
            ...
            <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded bg-input/40 border border-border font-mono text-sm"
              />
            ...
            <div className="mt-5 pt-5 border-t border-border/60 text-xs text-muted-foreground space-y-2">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-success" /> Verified once, accepted
                everywhere
              </div>
              <div className="flex items-center gap-2">
