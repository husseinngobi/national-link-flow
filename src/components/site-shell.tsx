      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-background/90 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center gap-6">
          <Link to="/" className="flex items-center gap-3 group">
            <img src={coatOfArms} alt="Republic of Uganda coat of arms" className="w-10 h-10 object-contain" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-8 text-sm">
          <div>
            ...
            <p className="text-muted-foreground text-xs leading-relaxed">
              National Government Data Exchange Hub — secure, citizen-centred digital service delivery for the Republic of Uganda.
            </p>
          </div>
          <div>
            <div className="font-semibold mb-2 text-xs uppercase tracking-wider text-gold">Services</div>
            <ul className="space-y-1 text-muted-foreground text-xs">
              <li><Link to="/services" className="hover:text-foreground">All services</Link></li>
              <li><Link to="/verify-status" className="hover:text-foreground">Verify status</Link></li>
              <li><Link to="/citizen" className="hover:text-foreground">Citizen portal</Link></li>
              <li><Link to="/assistant" className="hover:text-foreground">AI assistant</Link></li>
            </ul>
          </div>
          <div>
            <div className="font-semibold mb-2 text-xs uppercase tracking-wider text-gold">Trust &amp; Governance</div>
            <ul className="space-y-1 text-muted-foreground text-xs">
              <li><Link to="/security" className="hover:text-foreground">Security &amp; privacy</Link></li>
